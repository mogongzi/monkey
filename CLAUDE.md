...
1. **Do NOT write/edit files directly.** The user writes all code themselves. Only provide guidance, explanations, and code snippets in conversation — never modify project files.
